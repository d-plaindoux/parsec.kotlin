...
class T05_CharParser {
    ...
    fun shouldCharParserReturnsAccept() {
        ...
        val result = parser.invoke(CharReader.string("a")).fold({ it.value == 'a' }, { false })
    ...
    fun shouldCharParserReturnsFails() {
        ...
        val result = parser.invoke(CharReader.string("b")).fold({ false }, { true })
    ...
    fun shouldCharInStringParserReturnsAccept() {
        ...
        val result = parser.invoke(CharReader.string("-")).fold({ it.value == '-' }, { false })
    ...
    fun shouldCharParserOrParserReturnsAccept() {
        ...
        val result = parser.invoke(CharReader.string("b")).fold({ it.value == 'b' }, { false })
