...
class T03_OccurrenceParser {
    ...
    fun shouldOptionalParserWithEmptyStringReturnsAccept() {
        ...
        assertEquals(parser(Readers.new("")).fold({ it.value.first == null }, { false }), true)
    }
    ...
    fun shouldOptionalParserWithNonEmptyStringReturnsAccept() {
        ...
        assertEquals(parser(Readers.new("a")).fold({ it.value.first == 'a' }, { false }), true)
    }
    ...
    fun shouldOptionalRepeatableParserWithEmptyStringReturnsAccept() {
        ...
        assertEquals(parser(Readers.new("")).fold({ true }, { false }), true)
    }
    ...
    fun shouldOptionalRepeatableParserWithNonEmptyStringReturnsAccept() {
        ...
        assertEquals(parser(Readers.new("ab")).fold({ it.value.first == listOf('a','b') }, { false }), true)
    }
    ...
    fun shouldRepeatableNotParserWithNonEmptyStringReturnsAccept() {
        ...
        assertEquals(parser(Readers.new("bc")).fold({ it.value.first == listOf('b','c') }, { false }), true)
    }
    ...
    fun shouldRepeatableNotThenCharParserWithNonEmptyStringReturnsAccept() {
        ...
        assertEquals(parser(Readers.new("bca")).fold({ it.value == listOf('b','c') }, { false }), true)
    }
}