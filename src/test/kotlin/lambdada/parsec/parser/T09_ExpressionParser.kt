...
class T09_ExpressionParser {
    ...
    fun shouldParseNumber() {
        ...
        assertEquals(parser.invoke(Reader.string("42")).get(), 42f)
    }
    ...
    fun shouldParseAddition() {
        ...
        assertEquals(parser.invoke(Reader.string("42+23")).get(), 65f)
    }
    ...
    fun shouldParseAdditionAndMultiplication() {
        ...
        assertEquals(parser.invoke(Reader.string("42+(23*2)")).get(), 42f+(23f*2f))
    }
}