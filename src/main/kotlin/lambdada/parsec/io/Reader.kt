...
import lambdada.parsec.parser.GeneralizedParser
...
private class ReaderWithSkip<T>(private val skip: GeneralizedParser<T, *>, private val reader: Reader<T>) : Reader<T>(reader.offset) {
...
private class ParserReader<T, A>(private val p: GeneralizedParser<T, A>, private val r: Reader<T>) : Reader<A>(r.offset) {
...
infix fun <T, A> Reader<T>.tokenizeWith(r: GeneralizedParser<T, A>): Reader<A> = ParserReader(r, this)
infix fun <T> Reader<T>.skip(r: GeneralizedParser<T, *>): Reader<T> = ReaderWithSkip(r, this)
